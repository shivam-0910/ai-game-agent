...
**Project Title:** AI Game Agent — Reinforcement Learning Snake

**Organization:** Bright Hub Private Limited
...
This is to certify that the project titled **"AI Game Agent — Reinforcement Learning Snake"** submitted by **[Student Name]** of **[College Name]** (Registration/Roll Number: [Registration/Roll Number]) has been successfully completed as part of the Artificial Intelligence Internship program at Bright Hub Private Limited.

This project represents original work carried out by the intern under the guidance of **[Mentor Name]**. The work has been found satisfactory and meets the requirements of the internship program.
...
**Signature of Mentor** | **Signature of Intern**
------------------------|------------------------
[Mentor Name]           | [Student Name]
[Designation]           | [Registration/Roll Number]

---

## Acknowledgement

I would like to express my sincere gratitude to Bright Hub Private Limited for providing me with the opportunity to work on this project as part of the Artificial Intelligence Internship program. This experience has been invaluable in developing my understanding of reinforcement learning and deep neural networks.

I extend my heartfelt thanks to my mentor, [Mentor Name], for their constant guidance, support, and encouragement throughout the project. Their expertise and insights were instrumental in shaping the direction of this work.

I am also grateful to the entire team at Bright Hub Private Limited for creating a conducive learning environment and for the resources provided to complete this project successfully.

Finally, I thank my college and faculty for their support in enabling me to participate in this internship program.

---

## Abstract

This project presents the development of an AI agent capable of learning to play the classic game of Snake using Deep Reinforcement Learning. The agent employs a Deep Q-Network (DQN) algorithm to learn optimal gameplay strategies through interaction with a custom Gymnasium-compatible Snake environment. The project includes the design and implementation of a compact 11-feature state representation, a relative action space, and a reward function that guides the agent toward food while penalizing collisions.

The DQN agent is trained using experience replay, a target network for stability, and epsilon-greedy exploration. Following initial training, a systematic hyperparameter optimization process was conducted across five phases: reward values, epsilon decay, learning rate, secondary hyperparameters (gamma, replay capacity, batch size), and network architecture. The optimization identified that reducing the death penalty from -10.0 to -5.0 significantly improved performance, achieving a validation average score of 34.13 compared to the baseline of 29.26 (a 16.6% improvement). All other hyperparameters were retained at their baseline values.

The final trained model is preserved at `models/best_model.pth` and the repository includes comprehensive testing (426 tests), experiment tracking, and documentation. The project demonstrates the successful application of DQN to a classic game environment with reproducible training and evaluation protocols.
